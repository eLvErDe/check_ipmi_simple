...
def parse_args():
    ...
    argparser.add_argument('-S', '--sensor',     type=str ,    required=True,
                           help='IPMI chassis to query (Run ipmi-chassis by hand to list then (first column)')
    argparser.add_argument('-E', '--expected',   type=str ,    required=True,
                           help='IPMI chassis to expected state (Run ipmi-chassis by hand to list then (second column)')
